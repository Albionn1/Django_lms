...
function TeacherDetail(){
    ...
    return(
        <div className='container mt-3'>    
            <div className='row'>
                <div className='col-4'>
                    <img src='/logo512.png' className='img-thumbnail' alt='Course Image'></img>
                </div>
                <div className='col-8'>
                    <h3>John Doe </h3>
                    ...
                    <p className='fw-bold'>Skills: <Link to={'/category/php'}>PHP</Link>, <Link to={'/category/python'}>Python</Link>, <Link to={'/category/cpp'}>C++</Link></p>
            ...
            <div className='card mt-4'>
                ...
                <div className='list-group list-group-flush'> 
                    ...
                    <Link to={'/detail/1'} className='list-group-item list-group-item-action'>ReactJS Course</Link>
                    <Link to={'/detail/1'} className='list-group-item list-group-item-action'>Python Course</Link>
                    <Link to={'/detail/1'} className='list-group-item list-group-item-action'>C++ Course</Link>
                    <Link to={'/detail/1'} className='list-group-item list-group-item-action'>Java Course</Link>
                    <Link to={'/detail/1'} className='list-group-item list-group-item-action'>Advanced PHP Course</Link>
                </div>
            </div>
